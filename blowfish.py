...
Original file is located at
    https://colab.research.google.com/drive/1SxVb67ECVsgtFeQj__sIJJVQHls5O1yL
"""

p = [
      "243f6a88", "85a308d3", "13198a2e", "03707344", "a4093822","299f31d0", "082efa98", "ec4e6c89", "452821e6", "38d01377", 
      "be5466cf", "34e90c6c", "c0ac29b7", "c97c50dd", "3f84d5b5","b5470917", "9216d5d9", "8979fb1b" 
  ]
...
def func(L):
 ...
 # print(L)
  ...
  for i in range(0,8,2):
    #print(L[i:i+2])
    t[i//2] = int(L[i:i+2],16)
  #print(t)
  temp = int(s[0][t[0]],16)
  temp = (temp + int(s[1][t[1]],16)) % 2**32
        #print(temp)
  temp = temp ^ int(s[2][t[2]],16)
  temp = (temp + int(s[3][t[3]],16)) % 2**32
 # print(hex(temp))
  return temp
...
def decrypt(cipher):
    ...
    return hex(decrypted_data)[2:]

def key_gen(key):
  j=0
  for i in range(len(p)):
    p[i] = (int(p[i],16)) ^ (int(key[j:j+8],16))
    #p[i] = str(hex(p[i]))
    print("SubKey",i,hex(p[i]))
    j = (j+8)%len(key)
